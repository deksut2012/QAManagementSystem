...
public sealed class ProjectTests
{
    ...
    [Fact] public void Module_can_move_and_reorder(){var module=new ProductModule(Guid.NewGuid(),"CORE","Core",null,null,null,null);var parent=Guid.NewGuid();module.Move(parent,3,null);Assert.Equal(parent,module.ParentModuleId);Assert.Equal(3,module.SortOrder);}
}
