...
const editPermission:Partial<Record<Page,string>>={projects:'PROJECT.EDIT',releases:'PROJECT.EDIT',requirements:'REQUIREMENT.EDIT','test-cases':'TESTCASE.EDIT'}
...
type TestCaseItem={testCaseId:string;testCaseCode:string;title:string;priority:string;testType?:string;status:string;revisionNo:number;automationCandidate:boolean;steps:{stepNo:number}[]}
