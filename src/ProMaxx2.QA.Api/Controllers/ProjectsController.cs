...
[ApiController,Route("api/v1/projects"),Authorize(Policy="ProjectView")]
public sealed class ProjectsController(ProjectService service):ControllerBase
{
    [HttpGet] public Task<IReadOnlyList<ProjectDto>> List(CancellationToken ct)=>service.ListAsync(ct);
