...
public sealed record DashboardSummary(int TotalRequirements,int CoveredRequirements,decimal RequirementCoverage,int TotalCases,int ExecutedCases,decimal ExecutionProgress,int PassedCases,decimal PassRate,int OpenP0,int OpenP1,decimal? OverallScore,string RecommendedDecision,IReadOnlyList<DashboardModuleHealth>Modules,IReadOnlyList<DashboardUserPerformance>Users,IReadOnlyList<DashboardStatusSlice>StatusDistribution,DateTime GeneratedAt);
