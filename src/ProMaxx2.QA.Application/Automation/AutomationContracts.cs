...
public sealed record AutomationDashboardDto(int TotalTestCases, int AutomationCandidates, int AutomationCases, int Ready, int MaintenanceRequired, int Running, int PassToday, int FailToday, long? AverageDurationMs, int AgentsOnline, int AgentsTotal, decimal ReadyCoverage, decimal CandidateCoverage);
